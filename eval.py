...
# print(f"{args.model} || EM: {em_score} | Bleu: {bleu_score} | Rouge: {rouge_score} | GPT4score: {gpt4_score}")
# print(f"{args.model} || EM: {em_score['exact_match']} | Bleu: {bleu_score['bleu']} | Rouge: {rouge_score} | GPT4score: {gpt4_score}")
# print(f"{args.model} || EM: {em_score['exact_match']} | Bleu: {bleu_score['bleu']} | Rouge: {rouge_score}")
...
# print(f"{args.model} || EM: {em_score['exact_match']} | Rouge1: {rouge_score['rouge1']} | Rouge2: {rouge_score['rouge2']} | RougeL: {rouge_score['rougeL']} | RougeLSum: {rouge_score['rougeLsum']} | GPT4score: {gpt4_score}")
# print(f"GPT4score: {gpt4_score}")
