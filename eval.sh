...
# # RESULT_FILE=/shared/data3/bowenj4/llm-graph-plugin/Graph-CoT/results/$gpt_version/$DATASET/results.jsonl
# DOMAIN=Biology
# RESULT_FILE=/shared/data3/bowenj4/llm-graph-plugin/CoT/results/$gpt_version/maple-$DOMAIN/results.jsonl
# python eval.py --result_file $RESULT_FILE --model CoT-$gpt_version --openai_key $openai_key


## Graph CoT
gpt_version=Mixtral-8x7B-Instruct-v0.1
for DATASET in legal
do
echo $DATASET
RESULT_FILE=/shared/data3/bowenj4/llm-graph-plugin/Graph-CoT/results/$gpt_version/$DATASET/results.jsonl
python eval.py --result_file $RESULT_FILE --model Graph-CoT-$gpt_version --openai_key $openai_key
...
# for DOMAIN in Physics #Biology Chemistry Materials_Science Medicine
# do
# echo $DOMAIN
# RESULT_FILE=/shared/data3/bowenj4/llm-graph-plugin/Graph-CoT/results/$gpt_version/maple-$DOMAIN/results.jsonl
# python eval.py --result_file $RESULT_FILE --model Graph-CoT-$gpt_version --openai_key $openai_key
